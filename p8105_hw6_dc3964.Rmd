...
I have decided to use the stepwise method (both sides) to build my own hypothesized model, which it retained 13 variables in the end. When I compared my own model with other two models, my model has the lowest RMSE, meaning the stepwise method model is better than the other two models.