...
```
    ...
    ## mraceblack         -138.8297     9.9082 -14.012  < 2e-16 ***
    ## mracepuerto_rican  -101.7777    19.2911  -5.276 1.39e-07 ***
    ## mraceasian          -76.3488    42.3170  -1.804 0.071268 .  
    ## delwt                 4.1086     0.3921  10.478  < 2e-16 ***
    ## gaweeks              11.5806     1.4622   7.920 2.99e-15 ***
    ## smoken               -4.8443     0.5857  -8.272  < 2e-16 ***
    ## ppbmi                -9.2219     2.5771  -3.578 0.000349 ***
    ## babysexfemale        28.5570     8.4560   3.377 0.000739 ***
    ## parity               95.8952    40.3394   2.377 0.017487 *  
    ## ppwt                 -1.0679     0.5677  -1.881 0.060039 .  
...
![](p8105_hw6_dc3964_files/figure-gfm/unnamed-chunk-4-1.png)<!-- -->
...
| model_name        | avg_cv_rmse |
|:------------------|------------:|
| M1_Stepwise_Proxy |    273.0242 |
| M2_Simple         |    334.5858 |
| M3_Complex        |    288.8787 |

I have decided to use the stepwise method (both sides) to build my own
hypothesized model, which it retained 13 variables in the end. When I
compared my own model with other two models, my model has the lowest
RMSE, meaning the stepwise method model is better than the other two
models.
